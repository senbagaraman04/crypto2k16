...
{
    public sealed partial class AboutDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<LocalStorageDataConfig, About1Schema> ViewModel { get; set; }

        public AboutDetailPage()
        {
            this.ViewModel = new DetailViewModel<LocalStorageDataConfig, About1Schema>(new AboutConfig());
