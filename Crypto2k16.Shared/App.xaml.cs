...
using Crypto2k16.Services;

#if WINDOWS_APP
using Windows.System;
using Windows.UI.Core;
using Windows.UI.ApplicationSettings;
using Crypto2k16.AppFlyouts;
#endif
...
namespace Crypto2k16
{
    ...
    {
        private Guid APP_ID = new Guid("a32f84e3-7fa2-4793-89f5-648fc613c8de");
        public const string APP_NAME = "Crypto2k16";
        ...
        public App()
        {
            HockeyClient.Current.Configure("49217f4d41f44aca9d82b198a1e9b850");
