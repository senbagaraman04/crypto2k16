...
{
    public class CRYPTO2K16Config : SectionConfigBase<LocalStorageDataConfig, HtmlSchema>
    {
        ...
        public override LocalStorageDataConfig Config
        {
            get
            {
                ...
                {
                    FilePath = "/Assets/Data/CRYPTO2K16.htm"
                };
            }
        }
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("CRYPTO2K16ListPage");
            }
        }
